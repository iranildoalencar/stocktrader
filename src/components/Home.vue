<template>
    <div>
        ...
        <v-sheet :elevation="6" class="pa-2" color="success darken-1 mt-3">
            <v-icon class="white--text mr-3">info</v-icon>
            <span class="headline white--text font-weight-light">Clique em 'Finalizar Dia' para iniciar m novo dia!</span>
        </v-sheet>
